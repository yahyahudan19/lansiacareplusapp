                                    ...
                                    <div class="modal-body px-5 my-7">
                                        ...
                                        <form id="kt_modal_add_user_form" class="form" action="/admin/store/users" method="POST">
                                            ...
                                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    {{-- <label class="required fw-semibold fs-6 mb-2">Puskemas</label> --}}
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="username" name="puskesmas_id" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Puskemsmas" value="{{auth()->user()->puskesmas_id}}" hidden/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="/puskesmas/users/{{$user->id}}" class="menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
