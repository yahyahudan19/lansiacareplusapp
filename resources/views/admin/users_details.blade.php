                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                <!--begin::Input-->
                                                <input class="form-check-input me-3" name="user_role" type="radio" value="Dinkes" id="kt_modal_update_role_option_0" {{ $data_user->role == 'Dinkes' ? 'checked' : '' }} />
                                                <!--end::Input-->
                                                <!--begin::Label-->
                                                <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                    <div class="fw-bold text-gray-800">Dinas Kesehatan</div>
                                                    <div class="text-gray-600">Karyawan atau Anggota Dinas Kesehatan</div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Radio-->
