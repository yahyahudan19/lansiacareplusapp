                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">Agregat</li>
                            <!--end::Item-->
                            ...
                            <div class="modal-content">
                                <form action="/admin/laporan/exportExcel" method="GET">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="d-flex">
                                            <div class="row">
                                                 <!-- Tandai sebagai agregat -->
                                                <input type="hidden" name="is_agregat" value="1">
                                                <!--begin::Filter Date-->
                                                <div class="col-lg-12 mb-5">
                                                    <label class="fs-6 form-label fw-bold text-gray-900">Tanggal</label>
                                                    <br>
                            ...
                            <thead>
                                <tr class="fw-bold fs-6 text-gray-800 px-7">
                                    ...
                                    @foreach ($puskesmas as $unit)
                                        <th class="text-center align-middle">{{ $unit->nama }}</th>
                                    @endforeach
                                    ...
                                    <tr class="{{ $highlightClass }}">
                                        ...
                                        @foreach ($puskesmas as $unit)
                                            <td class="text-center align-middle fw-bold fs-6 px-7">
                                                {{ $results[$unit->nama][$kelompokNama][$indikator->nama] ?? 0 }}
                                            </td>
                                        @endforeach
                                        <td class="text-center align-middle fw-bold fs-6 px-7">
...
@section('plugins-last')
    ...
    <!--end::Filter Agregat Generate-->

    <!--begin::Filter Agregat Export-->
    <script>
        var start = moment().subtract(29, "days");
        var end = moment();
